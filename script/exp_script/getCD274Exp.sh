...
echo "samtools view -F 3844 -b -h ${INPUT} 9:5450502-5470567 | intersectBed -abam - -b ../db/CD274.bed -wao -bed -split > ${OUTPUT}.CD274.bed"
samtools view -F 3844 -b -h ${INPUT} 9:5450502-5470567 | intersectBed -abam - -b ../db/CD274.bed -wao -bed -split > ${OUTPUT}.CD274.bed
